...
const shadowHeader = () => {
    ...
    //When the scroll is greater than 50 viewport height, add the shadow-header to the class
...
const sendEmail = (e) =>{
    ...
    emailjs.sendForm('service_haat9ip', 'template_q4vmbao', '#contact-form', 'y6zQ8Jtb6nM_MCyu_')
    .then(() =>{
        // Show sent message
...
const scrollUp = () =>{
    ...
    this.scrollY >= 350 ? scrollUp.classList.add('show-scroll')
                        : scrollUp.classList.remove('show-srcoll')
}
...
// Previosly selected topic (id user selected)
...
if (selectedTheme) {
    // If the validation is fullfilled, we ask what the issue to know if we activated or desactivate the dark
